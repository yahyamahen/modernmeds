   ...
   <?php foreach ($pemesanan as $psn) : ?>
      ...
      <div style="margin-bottom: 1em;">
         ...
         <div style="width:50%; float:right;">
            ...
            <p>Status Pemesanan : Pesanan Selesai</p>
         </div>
      ...
      <div style="float:right; text-align:right; margin-right:2em">
         <p style="margin:2em 0em -3em 0em;">Dengan Hormat</p>
      ...
      $path = "files/" . $psn['username'] . "/nota";

      if ($psn['kode_pemesanan'] != null) {
         if (file_exists($path)) {
            // $mpdf->Output($filename, 'I');
            $mpdf->Output("files/" . $psn['username'] . "/nota/" . $filename, "F");
         } else {
      ...
      <script>
         ...
         alert('Nota berhasil dikirim pada email : " . $_POST['email'] . "');
